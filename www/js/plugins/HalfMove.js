...
(function () {
  ...
  var paramUpperNpTerrainTag = getParamNumber(
    ["UpperNpTerrainTag", "上半分移動不可地形"],
    0
  );
  var paramUpperNpRegionId = getParamNumber(
    ["UpperNpRegionId", "上半分移動不可Region"],
    0
  );
  var paramLowerNpTerrainTag = getParamNumber(
    ["LowerNpTerrainTag", "下半分移動不可地形"],
    0
  );
  var paramLowerNpRegionId = getParamNumber(
    ["LowerNpRegionId", "下半分移動不可Region"],
    0
  );
  var paramRightNpTerrainTag = getParamNumber(
    ["RightNpTerrainTag", "右半分移動不可地形"],
    0
  );
  var paramRightNpRegionId = getParamNumber(
    ["RightNpRegionId", "右半分移動不可Region"],
    0
  );
  var paramLeftNpTerrainTag = getParamNumber(
    ["LeftNpTerrainTag", "左半分移動不可地形"],
    0
  );
  var paramLeftNpRegionId = getParamNumber(
    ["LeftNpRegionId", "左半分移動不可Region"],
    0
  );
  var paramAllNpTerrainTag = getParamNumber(
    ["AllNpTerrainTag", "全方向移動不可地形"],
    0
  );
  var paramAllNpRegionId = getParamNumber(
    ["AllNpRegionId", "全方向移動不可Region"],
    0
  );
  ...
  Game_Map.prototype.isUpperNp = function (x, y) {
    return (
      (paramUpperNpTerrainTag > 0 &&
        paramUpperNpTerrainTag === this.terrainTag(x, y)) ||
  ...
  Game_Map.prototype.isLowerNp = function (x, y) {
    return (
      (paramLowerNpTerrainTag > 0 &&
        paramLowerNpTerrainTag === this.terrainTag(x, y)) ||
  ...
  Game_Map.prototype.isRightNp = function (x, y) {
    return (
      (paramRightNpTerrainTag > 0 &&
        paramRightNpTerrainTag === this.terrainTag(x, y)) ||
  ...
  Game_Map.prototype.isLeftNp = function (x, y) {
    return (
      (paramLeftNpTerrainTag > 0 &&
        paramLeftNpTerrainTag === this.terrainTag(x, y)) ||
  ...
  Game_Map.prototype.isAllNp = function (x, y) {
    return (
      (paramAllNpTerrainTag > 0 &&
        paramAllNpTerrainTag === this.terrainTag(x, y)) ||
  ...
  Game_CharacterBase.prototype.isCollidedWithEvents = function (x, y) {
    var result = _Game_CharacterBase_isCollidedWithEvents.apply(
      this,
      arguments
    );
  ...
  Game_Character.prototype.isHalfMove = function () {
    return (
      (Game_CharacterBase.prototype.isHalfMove.call(this) &&
        (!this._moveRouteForcing || !paramDisableForcing)) ||
      this.isHalfPosX() ||
      this.isHalfPosY()
    );
  };
