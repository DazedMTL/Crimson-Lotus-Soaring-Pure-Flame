...
(function () {
  ...
  var _Window_SavefileList_prototype_drawItem =
    Window_SavefileList.prototype.drawItem;
  Window_SavefileList.prototype.drawItem = function (index) {
    var PL_OFFSET_X = 464; // 2023/10/15
    var PL_OFFSET_Y = 19; // 2023/10/15
  ...
  var _Window_SavefileList_prototype_drawContents =
    Window_SavefileList.prototype.drawContents;
  Window_SavefileList.prototype.drawContents = function (info, rect, valid) {
    var PL_OFFSET_X = 0; // 2023/10/15  項目1～4を右端にしたいなら464だが、枠の描画にもPL_OFFSET_Xをつけること。
    ...
    if (rect.width >= 420) {
      ...
      if (valid) {
        ...
        if (BBSWLOO == 1) {
          ...
          this.drawText(
            TextManager.levelA + " " + info.level1,
            rect.x + 5,
            rect.y + BBSWLPY,
            40
          ); //72 23
          if (info.characters.length == 2) {
            this.drawText(
              TextManager.levelA + " " + info.level2,
              rect.x + 5 + 48,
              rect.y + BBSWLPY,
              40
            );
          ...
          if (info.characters.length == 3) {
            ...
            this.drawText(
              TextManager.levelA + " " + info.level3,
              rect.x + 5 + 48 + 48,
              rect.y + BBSWLPY,
              40
            );
          ...
          if (info.characters.length >= 4) {
            ...
            this.drawText(
              TextManager.levelA + " " + info.level4,
              rect.x + 5 + 48 + 48 + 48,
              rect.y + BBSWLPY,
              40
            );
    ...
    if (y2 >= lineHeight) {
      ...
      if (BBSWItem1 == 1) {
        this.drawText(
          info.title,
          rect.x + 495 + BBSWTF1 + PL_OFFSET_X,
          y2 - 2,
          266 - BBSWTF1,
          "right"
      ...
      if (BBSWItem2 == 1) {
        this.drawText(
          info.title,
          rect.x + 495 + BBSWTF2 + PL_OFFSET_X,
          y2 - 34,
          266 - BBSWTF2,
          "right"
      ...
      if (BBSWItem3 == 1) {
        this.drawText(
          info.title,
          rect.x + 215 + BBSWTF3 + PL_OFFSET_X,
          y2 - 2,
          266 - BBSWTF3,
          "right"
      ...
      if (BBSWItem4 == 1) {
        this.drawText(
          info.title,
          rect.x + 215 + BBSWTF4 + PL_OFFSET_X,
          y2 - 34,
          266 - BBSWTF4,
          "right"
