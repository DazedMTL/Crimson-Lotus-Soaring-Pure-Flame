...
BattleManager.processVictory = function () {
  //console.log('YEP_VictoryAftermath.js:processVictory');
...
BattleManager.playVictoryBGM = function () {
  //console.log('YEP_VictoryAftermath.js:playVictoryBGM');
  var victoryBgm = {
...
BattleManager.processVictoryFinish = function () {
  //console.log('YEP_VictoryAftermath.js:processVictoryFinish');
