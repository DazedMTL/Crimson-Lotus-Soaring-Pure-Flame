...
Game_Battler.prototype.checkHPGaugeNotes = function () {
  this.notetags().forEach(function (note) {
    if (typeof this._ehpgauge === "undefined")
      this._ehpgauge = [false, 0, 0, false, false];
    if (note == "Hide HP") {
...
HPGaugeSprite.prototype.loadBitmaps = function () {
  if (this.type === 0) {
    this._layImg = ImageManager.loadPicture("HPGaugeActor_A");
    this._meterImg = ImageManager.loadPicture("HPGaugeActor_B");
    this._numberImg = ImageManager.loadPicture("HPGaugeActor_C");
  } else {
    this._layImg = ImageManager.loadPicture("HPGaugeEnemy_A");
    this._meterImg = ImageManager.loadPicture("HPGaugeEnemy_B");
    this._numberImg = ImageManager.loadPicture("HPGaugeEnemy_C");
  }
};
...
HPGaugeSprite.prototype.enemyIDA = function () {
  ...
  if (typeof $gameSystem._hpGaugeEDef === "undefined")
    $gameSystem._hpGaugeEDef = [];
...
HPGaugeSprite.prototype.isVisible = function () {
  ...
  if (typeof this.battler()._ehpgauge === "undefined")
    this.battler()._ehpgauge = [false, 0, 0, false, false];
